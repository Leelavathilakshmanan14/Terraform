Here's your **properly formatted `README.md`** file, with clean Markdown formatting, correct code blocks, and section headings—all suitable for GitHub rendering:
